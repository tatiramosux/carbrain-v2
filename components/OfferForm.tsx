              ...
              <div className="bg-[#f4f6f8] border border-[#d8dee6] rounded-xl px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-[#002147] rounded-full flex items-center justify-center">
                    <FontAwesomeIcon icon={faCar} className="w-4 h-4 text-white" />
                  </div>
                  <div>
                    <div className="text-[10px] font-bold text-[#4a5c70] uppercase tracking-wider">
                      Your Vehicle
                    </div>
                    <div className="text-sm font-extrabold text-[#002147]">
                      {fulfilledVehicleSummary}
                    </div>
                  </div>
                </div>
                <div className="flex flex-col items-end">
                  {form.title && (
                    <div className="text-xs font-semibold text-[#5a6a7c] flex items-center gap-1">
                      <span className="capitalize">{form.title} Title</span>
                    </div>
                  )}
                  {form.mileage && (
                    <div className="text-[11px] font-medium text-[#5a6a7c]">
          ...
          {showNav && (
            <div className="px-4 sm:px-6 md:px-8 py-4 md:py-5 border-t border-gray-100 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {currentStep.id === "contact" ? "Get an Offer" : "Next"}
